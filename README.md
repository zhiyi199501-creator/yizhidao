...
- **结果**：本卦 / 之卦分 tab；各含卦辞、大象、六爻（上→初）；动爻红字；多动按规则标「主看」；可改所问与验证结果；经文据《易经证释》所引
- **历史**：SwiftData 本地保存；**时间**列表与**按卦**聚合（文王序）；同卦明细内分数字／金钱，数字按动爻位、金钱按动爻数筛选；可左滑删除
...
| 路径 | 内容 |
|---|---|
| `Yizhidao/App/` | 入口、`AppTheme` 浅色宣纸主题 |
